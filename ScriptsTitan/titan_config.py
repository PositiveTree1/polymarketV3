...
MAX_POSITIONS_PER_WALLET: int = 0;  MAX_WATCHLIST_SIZE: int = 0
PROFIT_TARGET_PCT: float = 0;  WALLET_EXIT_SELL: bool = True
...
USE_POSITIONS_API: bool = True
WALLET_TTL: int = 0;  MARKET_TTL: int = 0
ACTIVITY_LIMIT: int = 500;  TRADES_LIMIT: int = 1000
ACTIVITY_MAX_OFFSET: int = 3000;  TRADES_MAX_OFFSET: int = 3000
